...
class pay_Model extends model
{
	...
	public function diao($price,$ordersn){
...
$parameter = array(
    ...
    "payment_type"	=> '1', // 支付类型
    "notify_url"	=> "http://www.jun.com/index.php/Home/Member/membertwo", // 服务器异步通知页面路径
    "return_url"	=> "http://www.jun.com/index.php/Home/Member/membertwo", // 页面跳转同步通知页面路径
    "out_trade_no"	=> $ordersn, // 商户网站订单系统中唯一订单号
    "subject"	=> "订单", // 订单名称
    "total_fee"	=> $price, // 付款金额
    "body"	=> "1409phpD", // 订单描述 可选
    "show_url"	=> "", // 商品展示地址 可选
